...
All the environments are registered in the `anymal_locomotion` extension. They start
...
def main():
    """Print all environments registered in `anymal_locomotion` extension."""
    ...
    for task_spec in gym.registry.values():
        if (
            ("Anymal-Command" in task_spec.id or "Anymal-Nav" in task_spec.id) and 
